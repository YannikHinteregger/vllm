...
# Push-mode WRITE failure notification.
# Sent P worker -> D worker as PUSH_FAIL_NOTIF_PREFIX + the completion
# notification body. Stands in for the completion of a WRITE that could not
# be posted, so the consumer's notification count still adds up.
